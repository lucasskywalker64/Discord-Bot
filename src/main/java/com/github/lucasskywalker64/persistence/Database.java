        ...
        try (Statement st = conn.createStatement()) {
            ...
            st.executeUpdate("""
                            CREATE TABLE IF NOT EXISTS youtube_video_ids (
                                ...
                                FOREIGN KEY (channelId, guildId) REFERENCES youtube (channelId, guildId) ON DELETE CASCADE,
                                PRIMARY KEY (channelId, guildId, videoId)
                            )""");
            ...
            st.executeUpdate("""
                            CREATE TABLE IF NOT EXISTS shoutedout (
            ...
            st.executeUpdate("""
                            CREATE TABLE IF NOT EXISTS ticket_authorized_users (
            ...
            st.executeUpdate("""
                            CREATE TABLE IF NOT EXISTS ticket_attachment_keys (
                                ticketId INTEGER NOT NULL,
            ...
            st.executeUpdate("""
                            CREATE TABLE IF NOT EXISTS scheduled_ticket_closures (
